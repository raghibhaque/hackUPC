...
SYNONYMS: dict[str, str] = {
    ...
    # CRM column abbreviations (Salesforce-style)
    "fnm": "first_name", "lnm": "last_name",
    "eml": "email", "ph": "phone", "mbl": "mobile",
    "ttl": "title", "dpt": "department",
    "ownr": "owner", "ownr_id": "owner",
    "is_del": "deleted", "lst_act": "last_activity",
    "acct_nm": "name", "acct_typ": "type",
    "indsty": "industry",
    "ann_rev": "revenue", "emp_cnt": "employees",
    "blng_st": "address", "blng_cty": "city", "blng_cntry": "country",
    "prnt_acct": "parent",
    "oppty_nm": "name",
    "stg": "stage", "cls_dt": "close_date",
    "prob": "probability", "fcast_cat": "forecast",
    "is_clos_won": "won",
    "cmpny": "company",
    "conv_dt": "converted_date", "is_conv": "converted",
    "conv_acct": "company", "conv_cntct": "contact", "conv_oppty": "deal",
    "camp_nm": "name",
    "bdgt": "budget", "act_cost": "cost",
    "exp_resp": "expected_responses", "act_resp": "actual_responses",
    "exp_rev": "expected_revenue", "act_rev": "actual_revenue",
    "subj": "subject",
    "pri": "priority",
    "due_dt": "due_date", "comp_dt": "completed_date",
    "who_id": "contact_id", "what_id": "associated_id",
    "who_typ": "contact_type", "what_typ": "associated_type",
    "desc_txt": "description",
    "is_prim": "primary",
    "has_resp": "responded", "resp_dt": "response_date",
    "src": "source", "rtng": "score",
    "cntct_id": "contact_id", "acct_id": "company_id",
    "oppty_id": "deal_id", "camp_id": "campaign_id",
    "ld_id": "lead_id", "oc_id": "id", "mbr_id": "id",
